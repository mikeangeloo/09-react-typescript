    ...
    <>
      ...
      <section style={{ marginBottom: '44px' }}>
        ...
        <p className="page-body" style={{ margin: 0 }}>
          <code>useState</code> acepta un <strong style={{ color: 'var(--text-secondary)', fontWeight: 600 }}>genérico opcional</strong> para declarar el tipo del estado. En la mayoría de los casos, TypeScript puede inferir el tipo automáticamente desde el valor inicial. Solo necesitas el genérico cuando el tipo no se puede deducir del valor inicial.
        </p>
      </section>
      ...
      <section style={{ marginBottom: '44px' }}>
        ...
        <p className="page-body" style={{ marginBottom: '16px' }}>
          Cuando el valor inicial deja claro el tipo, TypeScript lo infiere sin que tengas que escribirlo.
        </p>
        <CodeBlock codigo={CODIGO_INFERIDO} archivo="inferencia.tsx" />
        <ConceptCard tipo="nota">
          Escribir <code>useState&lt;number&gt;(0)</code> es equivalente a <code>useState(0)</code> — el genérico es redundante cuando el valor inicial basta.
        </ConceptCard>
      </section>
      ...
      <section style={{ marginBottom: '44px' }}>
        ...
        <p className="page-body" style={{ marginBottom: '16px' }}>
          Usa el genérico cuando el valor inicial no refleja todos los valores posibles que tendrá el estado.
        </p>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '16px' }}>
          <ConceptCard tipo="error">
            <code>useState(null)</code> infiere el tipo <code>null</code>, lo que hace imposible asignar cualquier otro valor después.
          </ConceptCard>
          <ConceptCard tipo="exito">
            <code>useState&lt;string | null&gt;(null)</code> permite que el estado sea <code>string</code> o <code>null</code>.
          </ConceptCard>
        </div>
      ...
      <section style={{ marginBottom: '44px' }}>
        ...
        <p className="page-body" style={{ marginBottom: '16px' }}>
          Los union types son ideales para estados con un conjunto finito de valores posibles, como el estado de una petición HTTP.
        </p>
      ...
      <section style={{ marginBottom: '44px' }}>
        ...
        <p className="page-body" style={{ marginBottom: '16px' }}>
          Para objetos con múltiples propiedades, declara una <code>interface</code> o <code>type</code> y úsala como genérico. TypeScript verificará las actualizaciones de estado también.
        </p>
      ...
      <section>
        ...
        <p className="page-body" style={{ marginBottom: '16px' }}>
          Analiza cada comentario y corrige los problemas de tipos. En el último caso, piensa qué valor no está incluido en el union type.
        </p>
