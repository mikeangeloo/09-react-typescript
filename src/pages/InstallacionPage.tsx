...
const elemento = <Boton etiqueta="Guardar" />;
`;
    ...
    <>
      ...
      <section style={{ marginBottom: '44px' }}>
        ...
        <p className="page-body" style={{ margin: 0 }}>
          TypeScript agrega <strong style={{ color: 'var(--text-secondary)', fontWeight: 600 }}>definiciones de tipos estáticos</strong> a JavaScript. Esto permite al compilador detectar errores antes de ejecutar el código y mejora el autocompletado en el editor. Con Vite, la plantilla <code>react-ts</code> genera todo lo necesario para comenzar a trabajar de inmediato.
        </p>
      </section>
      ...
      <section style={{ marginBottom: '44px' }}>
        ...
        <ConceptCard tipo="nota">
          La plantilla <code>react-ts</code> ya incluye <code>@types/react</code> y <code>@types/react-dom</code>,
          que son los tipos de React para TypeScript. No necesitas instalarlos por separado.
        </ConceptCard>
      </section>
      ...
      <section style={{ marginBottom: '44px' }}>
        ...
        <p className="page-body" style={{ marginBottom: '16px' }}>
          El archivo <code>tsconfig.json</code> es la configuración del compilador de TypeScript. Vite genera una configuración sensible que puedes usar sin cambios.
        </p>
        <CodeBlock codigo={CODIGO_TSCONFIG} lenguaje="json" archivo="tsconfig.json" />
      </section>
      ...
      <section style={{ marginBottom: '44px' }}>
        ...
        <p className="page-body" style={{ marginBottom: '16px' }}>
          La opción <code>"strict": true</code> es la más importante del <code>tsconfig.json</code>. Activa un conjunto de verificaciones que hacen que TypeScript detecte más errores potenciales.
        </p>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginBottom: '16px' }}>
          <ConceptCard tipo="error">
            Sin <code>strict</code>, TypeScript es más permisivo y puede dejar pasar errores que aparecerán en tiempo de ejecución.
          </ConceptCard>
          <ConceptCard tipo="exito">
            Con <code>"strict": true</code>, TypeScript verifica que <code>null</code> se use solo donde es explícitamente permitido y prohíbe variables sin tipo.
          </ConceptCard>
        </div>
      ...
      <section>
        ...
        <p className="page-body" style={{ marginBottom: '16px' }}>
          Corrige los tres errores de TypeScript que aparecen en el panel inferior. Haz clic en el código y edítalo directamente.
        </p>
